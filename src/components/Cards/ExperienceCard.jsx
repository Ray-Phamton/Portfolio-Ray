export function ExperienceCard ({ role, team, timeframe, icon, achievements, children }) {
  return (
    ...
    <div className='lg:w-2/5 bg-zinc-700 rounded-2xl shadow-xl hover:shadow-violet-700/50 transition duration-300 hover:-translate-y-2 pl-10 pt-4 mt-8 lg:mt-0'>
      <div className='flex flex-rows'>
        <div className='w-3/4'>
          <h3 className='text-xl font-bold dark:text-violet-400'>
            {role}
          </h3>
      ...
      <div className='mt-6 flex-grow mr-24 lg:mr-8'>

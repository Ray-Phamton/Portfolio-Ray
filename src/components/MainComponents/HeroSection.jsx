    ...
    >
      ...
      <section className='flex flex-col sm:flex-row lg:pl-32 md:pl-20 sm:pl-12  h-full z-10 pt-20'>
        <section className='flex flex-col justify-center sm:items-stretch sm:w-1/2 items-center h-full gap-2 z-10'>
          <img className=' sm:hidden h-52 mask-radial-at-center mask-radial-from-58% mask-radial-to-75% rounded-full object-cover mt-6' src='/Raymon-perfil.jpeg' alt='image of Raymon Reyes' />
        ...
        <section className='hidden sm:flex flex-col justify-center items-center h-full w-1/2 z-10'>
          <img className=' lg:h-80 md:h-72 sm:h-60 h-52 mask-radial-at-center mask-radial-from-58% mask-radial-to-75% rounded-full object-cover' src='/Raymon-perfil.jpeg' alt='image of Raymon Reyes' />
